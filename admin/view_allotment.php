                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <a title="Visual Seating Map" href="view_seating.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-warning" style="background:#673AB7; border-color:#673AB7;"><i class="fa fa-th" style="color:#fff;"></i></button></a>

                                                  <a title="View Student List" href="view_student_list.php?id=<?=$row['id'];?>"><button type="button" class="btn btn-xs btn-success" ><i class="fa fa-list"></i></button></a>

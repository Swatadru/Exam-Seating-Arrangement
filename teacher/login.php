        ...
        <div class="login-form">
            <form method="POST">
                <div class="form-group mb-4">
                    <label class="text-muted mb-2">Teacher Email</label>
                    <input type="email" name="email" class="form-control" placeholder="teacher@example.com" required="" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: #fff;">
                </div>
                <div class="form-group mb-4">
                ...
                <button type="submit" name="btn_login" class="btn btn-primary w-100 py-3 mt-2">Teacher Sign In</button>

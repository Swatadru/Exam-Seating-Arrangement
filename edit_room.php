...
if(isset($_POST["btn_update"]))
{
    extract($_POST);
      ...
      $q1="UPDATE `room` SET `name`='$name',`type_id`='$type_id',`strength`='$strength' WHERE `id`='".$_GET['id']."'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" min="0" name="strength" class="form-control" value="<?php echo $strength; ?>" placeholder=" strength" required="">
                                                </div>
                                            </div>
                                        </div>
